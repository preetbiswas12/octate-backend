...
export type WebSocketMessageType = 'join-room' | 'leave-room' | 'operation' | 'cursor-update' | 'selection-update' | 'presence-update' | 'document-open' | 'document-close' | 'participant-joined' | 'participant-left' | 'participant-updated' | 'room-updated' | 'sync-request' | 'sync-response' | 'error' | 'ping' | 'pong';
...
export declare function isRoomId(value: string): value is RoomId;
export declare function isParticipantId(value: string): value is ParticipantId;
export declare function isDocumentId(value: string): value is DocumentId;
export declare function isOperationId(value: string): value is OperationId;
export declare function isUserId(value: string): value is UserId;
